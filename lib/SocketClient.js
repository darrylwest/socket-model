...
var SocketClient = function(options) {
    ...
    if (!log) throw new Error('socket client must be constructed with a log');
    if (!socketFile) throw new Error('socket client must be constructed with a socket file name');
    if (!reader) throw new Error('socket client must be constructed with a reader object');
    if (!writer) throw new Error('socket client must be constructed with a writer object');
};
